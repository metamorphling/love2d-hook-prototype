...
function player:init()
    player.display = {x=startingBlock.display.x, y=startingBlock.display.y - startingBlock.display.height/2, width=15, height=15}
    ...
    player.fixture:setUserData("Captain")
